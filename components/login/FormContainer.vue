<template>
  <div
    class="min-h-screen w-full md:bg-center bg-left bg-login-bg bg-cover flex justify-center items-center"
  >
    <div
      class="lg:px-[76px] w-full sm:px-8 px-4 lg:py-12 py-14 flex justify-between md:flex-row flex-col max-h-[800px] max-w-[2000px] mx-auto"
    >
      <div
      ...
      >
        ...
        <p
          class="text-center font-roboto text-xs font-normal px-[14px] bg-white"
        >
