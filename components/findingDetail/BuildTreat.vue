  ...
  <div class="flex flex-wrap w-full mb-[25px]">
    ...
    <div class="xl:w-[80%] w-full xl:pe-[18px]">
      ...
      >
        ...
        <div
          v-for="(content, index) in findingDetailbuildThreats"
          class="xl:w-3/12 md:w-4/12 xl:px-0 px-3 small:w-6/12 w-full"
          :class="
            index === 0
              ? '!xl:pl-0'
              : '' || index === findingDetailbuildThreats.length - 1
              ? '!xl:pr-0 !xl:pe-0'
              : ''
          "
          :key="index"
    ...
    <div class="xl:w-[20%] flex flex-col items-center w-full xl:ps-[18px]">
      ...
      <!-- Looping through findingDetailDependenciesThreats and rendering Card components -->
      <div
        v-for="(content, index) in findingDetailDependenciesThreats"
