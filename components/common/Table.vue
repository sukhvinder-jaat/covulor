        ...
        <thead class="ps-5">
          <tr class="bg-hawkasBlue">
            <th v-for="(heading, index) in header" :key="index" scope="col"
              ...
              <span :class="index === 0 ? 'block' : 'hidden'"><svg width="26" height="16" viewBox="0 0 26 16"
                  fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M6.5 3L9.31458 7.875L12.1292 12.75H6.5H0.870835L3.68542 7.875L6.5 3Z" fill="#8220FF" />
                  <path opacity="0.5"
