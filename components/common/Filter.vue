    ...
    <UPopover :popper="{ placement: 'bottom-start' }">
      ...
      <template #panel>
        ...
        >
          ...
          <span
            class="max-w-[460px] top-10 w-full h-[1px] block absolute bg-ghostWhiteLight"
          ></span>
          <div>
            <form>
              <div class="mt-[38px] flex items-center">
                <input type="radio" id="age1" name="age" value="30" />
                <label
                  for="age1"
                  class="font-roboto font-medium text-sm leading-4 tracking-[5%] ps-[5px] text-lightToBlack cursor-pointer"
                  >Default</label
                >
              </div>
              <div class="mt-4 sm:flex gap-6 items-center justify-between">
                <div class="w-6/12 flex items-center">
                  ...
                  <label
                    for="age2"
                    class="text-lightToBlack font-roboto font-medium text-sm leading-4 tracking-[5%] ps-[5px] cursor-pointer"
                    >Repository ID</label
                  >
                </div>
              ...
              <div class="mt-4 sm:flex gap-6 items-center justify-between">
                <div class="w-6/12 flex items-center">
                  ...
                  <label
                    for="age3"
                    class="font-roboto font-medium text-lightToBlack text-sm leading-4 tracking-[5%] ps-[5px] cursor-pointer"
            ...
            <p
              class="font-inter font-medium text-sm leading-4 tracking-[5%] mt-4"
            >
              + Add
            </p>
            <div class="relative">
              <span
                class="h-[1px] absolute w-full bg-ghostWhiteLight top-[-11px]"
              ></span>
              <p class="font-bold text-sm text-purple leading-4 mt-7">
                Clear filters
              </p>
            </div>
          </div>
