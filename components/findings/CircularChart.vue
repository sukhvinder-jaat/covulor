<template>
  ...
  <div id="chart" class="lg:w-[500px] 2xl:w-[600px] small:w-[350px] w-[270px] relative circle_chart">
    <!-- ApexCharts component for displaying the chart -->
    <ClientOnly>
      <VueApexCharts type="polarArea" :options="chartOptions" :series="series"></VueApexCharts>
    </ClientOnly>
    ...
    <div
      ...
      <div
        ...
        <div class="w-full h-full flex justify-center items-center flex-col bg-white rounded-full">
          <!-- Text displaying 'Total' -->
          <p class="text-comet text-sm font-normal font-roboto">{{findingPieChartData.labels}}</p>
          <!-- Total value -->
          <h3 class="text-midnightBlue text-base sm:text-xl font-bold font-roboto">
